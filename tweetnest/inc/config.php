<?php
	...
	$config = array(
		// REQUIRED VALUES ------------------------------------
		'consumer_key'       => 'MiNIIOZIciNEvgyDfmrfQ', // Your Twitter app consumer key
		'consumer_secret'    => 'cUwRg0kFes5ifqnDEUe3xdsOSLcUZBrON6kc4tOuc', // Your Twitter app consumer secret
		'twitter_screenname' => 'DerZyklop', // Twitter screen name of the one whose tweets are being recorded
		'your_tw_screenname' => 'DerZyklop', // Your Twitter screen name -- the one we log in as. Usually the same as above, but does not have to be.
		'twitter_token'      => '25325637-2DZtCMP5Sq6gpTvtC1LoHE6xaGrzjfB8Bzgb5MbZ9', // Twitter OAuth secret token (usually filled in automatically)
		'twitter_token_secr' => 'GuZrjYw2SqUbqvsFuOENHovgaWbGZoqBIyP53fLAnxfpB', // Twitter OAuth token (usually filled in automatically)
		'timezone'           => 'Europe/Berlin', // Choose one of these: http://php.net/manual/en/timezones.php
		...
		'db'                 => array(
			...
			'username'       => 'zyklop', // The username to log in to your database
			'password'       => 'DokDawtiag', // The password to log in to your database
			'database'       => 'zyklop_main', // The database name
			'table_prefix'   => 'tnest_', // The prefix to table names in the database
			'charset'	 => ''  // The charset of your database
		),
		
		// OPTIONAL -------------------------------------------
		// If you want to access your maintenance PHP files by HTTP, specify an admin password.
		'maintenance_http_password' => 'ZIciNEvgyDfmrfQMiNIIO', 
